...
# loaded_data = np.load("/Users/wpgoh/Documents/fyp-teleprompter/results/Short/Experiment1.0/data.npz")

# loadedControlData = np.load("/Users/wpgoh/Documents/fyp-teleprompter/control/controlShortData.npz")
loaded_data = np.load("/Users/wpgoh/Documents/fyp-teleprompter/User Studies/Kai Bin/Control/Experiment1.0/data.npz")

loadedControlData = np.load("/Users/wpgoh/Documents/fyp-teleprompter/User Studies/Kai Bin/controlDataKB.npz")
controlData = loadedControlData["controlDataKB"]
